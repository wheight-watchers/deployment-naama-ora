...
module.exports = {
    getDiaryByUserId: async function (req, res, next) {
        try {
    ...
    addDiary: async function (req, res, next) {
        try {
            const userId = req.params.id;
            let diary = req.body;
    ...
    updateDiary: async function (req, res, next) {
        try {
            const userId = req.params.id;
    ...
    deleteDairy: async function (req, res, next) {
        try {
            const userId = req.params.id;
